...
public class Conditional {
    public static void main(String[] args) {
        ...
        System.out.println(name == "jade"); // false
        System.out.println(name.equals("jade")); // true  // System.out.println("jdae".equals(name));
        ...
        * 
        * 동일한 문자열 리터널이 사용될 경우, JAVA는 String pool 이라는 메모리 영역에 문자열을 저장
